...
execute as @a[nbt=!{RootVehicle:{Entity:{id:"minecraft:llama"}}},x=238,y=39,z=-381,dx=35,dy=20,dz=35,tag=!debug] at @s if block ~ 1 ~ minecraft:glowstone run playsound minecraft:entity.villager.no master @s ~ ~ ~ 100 0
execute as @a[nbt=!{RootVehicle:{Entity:{id:"minecraft:llama"}}},x=238,y=39,z=-381,dx=35,dy=20,dz=35,tag=!debug,advancements={music:music_2=false}] at @s if block ~ 1 ~ minecraft:glowstone run advancement grant @s only music:music_2

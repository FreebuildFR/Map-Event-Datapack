...
execute as @a[x=215,y=69,z=-288,dx=15,dy=2,dz=45] run give @s diamond_shovel[can_break=[{blocks:"obsidian"},{blocks:"dirt"}],custom_name="Pelleteuse",unbreakable={},enchantments={"efficiency":100},enchantment_glint_override=false,tooltip_display={hide_tooltip:true,hidden_components:["enchantments","unbreakable"]}] 1

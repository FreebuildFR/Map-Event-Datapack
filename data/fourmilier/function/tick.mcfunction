...
# Arrivee en bas
execute as @a[x=215,y=21,z=-288,dx=4,dy=0,dz=45,tag=fourmilier] if entity @s[scores={fourmilier_win=1..}] run advancement grant @s only fourmilier:fourmilier_1
execute as @a[x=215,y=21,z=-288,dx=4,dy=0,dz=45,tag=fourmilier] if entity @s[scores={fourmilier_win=5..}] run advancement grant @s only fourmilier:fourmilier_2
execute as @a[x=215,y=21,z=-288,dx=4,dy=0,dz=45,tag=fourmilier] if entity @s[scores={fourmilier_win=10..}] run advancement grant @s only fourmilier:fourmilier_3

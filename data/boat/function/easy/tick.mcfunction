execute as @e[type=#minecraft:boat,x=-341,y=20,z=-271,dx=111,dy=5,dz=224] at @s unless entity @p[distance=..2] run kill @s
execute as @a[nbt=!{RootVehicle:{}},x=-341,y=20,z=-271,dx=111,dy=5,dz=224,tag=!debug] run tp @s -327.5 29.0 -191.5 0 0

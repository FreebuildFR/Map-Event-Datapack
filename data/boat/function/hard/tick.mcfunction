execute as @e[type=boat,x=-103,y=12,z=-271,dx=88,dy=4,dz=74] at @s unless entity @p[distance=..2] run kill @s
execute as @a[nbt=!{RootVehicle:{Entity:{id:"minecraft:boat"}}},x=-103,y=12,z=-271,dx=88,dy=4,dz=74,tag=!debug] run tp @s -51.5 21.0 -259.5 90 0

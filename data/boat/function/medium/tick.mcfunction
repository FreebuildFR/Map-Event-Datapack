execute as @e[type=#minecraft:boat,x=-227,y=18,z=-271,dx=123,dy=4,dz=134] at @s unless entity @p[distance=..2] run kill @s
execute as @a[nbt=!{RootVehicle:{}},x=-227,y=18,z=-271,dx=123,dy=4,dz=134,tag=!debug] run tp @s -211.5 28.0 -182.5 180 0

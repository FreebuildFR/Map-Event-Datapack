...
execute positioned 611 23 72 unless entity @e[type=player,dx=110,dy=35,dz=100] if score npc_enfer_count pve_vague_enfer matches 0 run setblock 673 71 132 dark_oak_wall_sign[facing=west]{front_text:{messages:[[""],["",{"text":"Commencer","color":"yellow","bold":true}],["",{"text":"la partie","color":"yellow","bold":true}],["",{"text":"*clique droit*","italic":true,"color":"white"}]]},is_waxed:1b} replace

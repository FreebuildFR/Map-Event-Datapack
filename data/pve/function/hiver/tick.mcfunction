...
execute positioned 524 25 72 unless entity @e[type=player,dx=80,dy=20,dz=110] if score npc_hiver_count pve_vague_hiver matches 0 run setblock 573 66 124 dark_oak_wall_sign[facing=west]{front_text:{messages:[[""],["",{"text":"Commencer","color":"yellow","bold":true}],["",{"text":"la partie","color":"yellow","bold":true}],["",{"text":"*clique droit*","italic":true,"color":"white"}]]},is_waxed:1b} replace

...
execute positioned 430.14 11.65 73.00 unless entity @e[type=player,dx=90,dy=20,dz=90] if score npc_nature_count pve_vague_nature matches 0 run setblock 487 59 127 dark_oak_wall_sign[facing=west]{front_text:{messages:['[""]','["",{"text":"Commencer","color":"yellow","bold":true}]','["",{"text":"la partie","color":"yellow","bold":true}]','["",{"text":"*clique droit*","italic":true,"color":"white"}]']},is_waxed:1b} replace

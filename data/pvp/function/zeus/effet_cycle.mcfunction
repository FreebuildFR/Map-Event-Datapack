...
execute positioned 249 21 174 as @a[dx=2,dy=2,dz=2] at @s if block ~ ~-1 ~ minecraft:red_concrete run summon minecraft:area_effect_cloud 249 21 174 {Radius:0f,Duration:400,CustomName:"zeus_e1"}
execute positioned 249 21 174 as @a[dx=2,dy=2,dz=2] at @s if block ~ ~-1 ~ minecraft:red_concrete run particle dust{color:[1.000,0.180,0.122],scale:1} ~ ~0.5 ~ 0.8 0.6 0.8 0.5 30 normal
...
execute positioned 249 21 174 unless entity @e[type=minecraft:area_effect_cloud,name="zeus_e1",distance=..2.0] run fill ~3 ~3 ~3 ~-3 ~-3 ~-3 red_concrete replace gray_wool
...
execute positioned 249 21 208 as @a[dx=2,dy=2,dz=2] at @s if block ~ ~-1 ~ minecraft:yellow_concrete run summon minecraft:area_effect_cloud 249 21 208 {Radius:0f,Duration:400,CustomName:"zeus_e2"}
execute positioned 249 21 208 as @a[dx=2,dy=2,dz=2] at @s if block ~ ~-1 ~ minecraft:yellow_concrete run particle dust{color:[1.000,0.980,0.122],scale:1} ~ ~0.5 ~ 0.8 0.6 0.8 0.5 30 normal

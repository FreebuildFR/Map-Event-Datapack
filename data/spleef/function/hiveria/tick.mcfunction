...
#Reset des panneaux
execute if score npc_score spleef_hiveria matches 0 unless block 442 51 -357 minecraft:dark_oak_wall_sign run setblock 442 51 -357 minecraft:dark_oak_wall_sign[facing=north]{front_text:{messages:['{"text":"Commencer","bold":true,"color":"yellow"}','{"text":"la partie","bold":true,"color":"yellow"}','{"text":""}','{"text":"*clique droit*","italic":true,"color":"white"}']},is_waxed:1b}
execute if score npc_score spleef_hiveria matches 0 unless block 442 51 -365 minecraft:dark_oak_wall_sign run setblock 442 51 -365 minecraft:dark_oak_wall_sign[facing=south]{front_text:{messages:['{"text":"Commencer","bold":true,"color":"yellow"}','{"text":"la partie","bold":true,"color":"yellow"}','{"text":""}','{"text":"*clique droit*","italic":true,"color":"white"}']},is_waxed:1b}

...
#Reset des panneaux
execute if score npc_score spleef_futuria matches 0 unless block 349 81 -361 minecraft:dark_oak_wall_sign run setblock 349 81 -361 minecraft:dark_oak_wall_sign[facing=south]{front_text:{messages:['{"text":"Commencer","bold":true,"color":"yellow"}','{"text":"la partie","bold":true,"color":"yellow"}','{"text":""}','{"text":"*clique droit*","italic":true,"color":"white"}']},is_waxed:1}
execute if score npc_score spleef_futuria matches 0 unless block 349 81 -349 minecraft:dark_oak_wall_sign run setblock 349 81 -349 minecraft:dark_oak_wall_sign[facing=north]{front_text:{messages:['{"text":"Commencer","bold":true,"color":"yellow"}','{"text":"la partie","bold":true,"color":"yellow"}','{"text":""}','{"text":"*clique droit*","italic":true,"color":"white"}']},is_waxed:1}

...
#Reset des panneaux
execute if score npc_score spleef_hiveria matches 0 unless block 393 55 -358 minecraft:dark_oak_wall_sign run setblock 393 55 -358 minecraft:dark_oak_wall_sign[facing=east]{front_text:{messages:['{"text":"Commencer","bold":true,"color":"yellow"}','{"text":"la partie","bold":true,"color":"yellow"}','{"text":""}','{"text":"*clique droit*","italic":true,"color":"white"}']},is_waxed:1}
execute if score npc_score spleef_hiveria matches 0 unless block 405 55 -358 minecraft:dark_oak_wall_sign run setblock 405 55 -358 minecraft:dark_oak_wall_sign[facing=west]{front_text:{messages:['{"text":"Commencer","bold":true,"color":"yellow"}','{"text":"la partie","bold":true,"color":"yellow"}','{"text":""}','{"text":"*clique droit*","italic":true,"color":"white"}']},is_waxed:1}

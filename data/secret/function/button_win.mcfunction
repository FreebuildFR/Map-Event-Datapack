...
execute positioned -95.51 21.00 -395.37 as @e[type=item_frame,dx=11,dy=10,dz=11] run data merge entity @s {Item:{id:"minecraft:filled_map",components:{"minecraft:map_id":33}}}

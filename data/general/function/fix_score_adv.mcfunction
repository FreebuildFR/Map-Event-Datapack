...
# Tir a l'arc
scoreboard players set @s[advancements={arc:arc_3=true},scores={arc_interrupteur=..0}] arc_interrupteur 1
scoreboard players set @s[advancements={arc:arc_3_1=true},scores={arc_interrupteur=..29}] arc_interrupteur 30
scoreboard players set @s[advancements={arc:arc_3_11=true},scores={arc_interrupteur=..49}] arc_interrupteur 50

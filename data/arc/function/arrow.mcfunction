...
#particule
execute as @a[x=-6,y=13,z=-396,dx=145,dy=79,dz=114,tag=p_cloud,nbt=!{Inventory:[{id:"minecraft:tipped_arrow",Slot:-106b}]}] run item replace entity @s weapon.offhand with tipped_arrow{CustomPotionColor:16777215,display:{Name:'{"text":"Flèche nuage"}'}} 1
execute as @a[x=-6,y=13,z=-396,dx=145,dy=79,dz=114,tag=p_end_rod,nbt=!{Inventory:[{id:"minecraft:tipped_arrow",Slot:-106b}]}] run item replace entity @s weapon.offhand with tipped_arrow{CustomPotionColor:16383905,display:{Name:'{"text":"Flèche de l\'end"}'}} 1
execute as @a[x=-6,y=13,z=-396,dx=145,dy=79,dz=114,tag=p_composter,nbt=!{Inventory:[{id:"minecraft:tipped_arrow",Slot:-106b}]}] run item replace entity @s weapon.offhand with tipped_arrow{CustomPotionColor:3340870,display:{Name:'{"text":"Flèche étoile"}'}} 1
execute as @a[x=-6,y=13,z=-396,dx=145,dy=79,dz=114,tag=p_flame,nbt=!{Inventory:[{id:"minecraft:tipped_arrow",Slot:-106b}]}] run item replace entity @s weapon.offhand with tipped_arrow{CustomPotionColor:16398868,display:{Name:'{"text":"Flèche flamme"}'}} 1
execute as @a[x=-6,y=13,z=-396,dx=145,dy=79,dz=114,tag=p_witch,nbt=!{Inventory:[{id:"minecraft:tipped_arrow",Slot:-106b}]}] run item replace entity @s weapon.offhand with tipped_arrow{CustomPotionColor:15222522,display:{Name:'{"text":"Flèche sort"}'}} 1

...
execute as @a[x=3,y=86,z=-388,dx=0,dy=0,dz=0,nbt={RootVehicle:{Entity:{id:"minecraft:minecart"}}}] run item replace entity @s weapon.mainhand with bow[custom_name='"Arc"',unbreakable={show_in_tooltip:true},enchantments={levels:{"minecraft:infinity":1},show_in_tooltip:false}]

...
execute positioned 781.98 17.00 -189.12 run advancement grant @a[distance=..3.0] only elytra:elytra_sylvestre_1
execute positioned 717.94 21.00 -198.08 run advancement grant @a[distance=..2.0] only elytra:elytra_sylvestre_2

...
execute positioned 680.51 18.00 -199.52 run advancement grant @a[distance=..3.0] only elytra:elytra_3
execute positioned 632.01 27.00 -158.91 run advancement grant @a[distance=..2.0] only elytra:elytra_3_1

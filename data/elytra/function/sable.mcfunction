...
execute positioned 471.46 16.00 -73.45 run advancement grant @a[distance=..3.0] only elytra:elytra_4
execute positioned 542.65 36.00 -112.53 run advancement grant @a[distance=..3.0] only elytra:elytra_4_1
...
execute positioned 468.75 15.50 -74.11 as @a[tag=elytra_secret_2,dx=10,dy=1,dz=3] run advancement grant @s only artefacts:artefact_4

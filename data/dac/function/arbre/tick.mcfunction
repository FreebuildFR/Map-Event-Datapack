...
execute as @a[x=-72,y=15,z=-37,dx=50,dy=15,dz=50] at @s if block ~ ~-1 ~ #minecraft:logs run advancement grant @s only dac:dac_arbre_secret_racine
...
advancement grant @a[x=-72,y=15,z=-37,dx=50,dy=40,dz=50,scores={dac_arbre=1..}] only dac:dac_arbre

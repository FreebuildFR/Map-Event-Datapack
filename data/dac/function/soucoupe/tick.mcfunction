...
execute positioned -102 17 -8 as @a[distance=..6.0] at @s if block ~ ~-1 ~ minecraft:emerald_block run advancement grant @s only dac:dac_3_1
...
advancement grant @a[x=-127,y=18,z=-32,dx=50,dy=60,dz=50,scores={dac_soucoupe=1..}] only dac:dac_3
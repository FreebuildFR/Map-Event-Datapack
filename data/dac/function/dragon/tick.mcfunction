...
advancement grant @a[x=-173,y=64,z=-16,dx=33,dy=60,dz=37,scores={dac_dragon=1..}] only dac:dac_dragon
execute positioned -182.5 112.0 -1.5 run advancement grant @a[distance=..1.5] only dac:dac_dragon_secret_estomac
